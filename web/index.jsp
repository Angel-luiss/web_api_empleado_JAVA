...
<html>
    <head>
        ...
        <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.2.2/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-Zenh87qX5JnK2Jl0vWa8Ck2rdkQ2Bzep5IDxbcnCeuOxjzrPF/et3URy9Bv1WTRi" crossorigin="anonymous">    
         <link rel="stylesheet" href="usoweb/css/estilos.css">
    </head>
    <body>
         <header>
            <a href="#inicio" class="logo"> Formulario empleados </a>
        ...
        <section class="inicio" id="inicio">
              <div class="image">
                <img src="usoweb/imagenes/P1.jpeg" alt="">
            </div>
            <div class="content">
        ...
        <section class="Estudiante" id="Estudiante">
            <div class="image">
                <img src="usoweb/imagenes/P2.jpeg" alt="">
            </div>
            <div class="contendor">
      ...
      <div class="modal-content">
        <div class="modal-body">
            ...
            <form action="sr_empleado" method= "get" class="form-group">
                ...
                <input type="text" name="txt_nombre" id="txt_nombre" class="form-control" placeholder="Nombre 1 Nombre 2" required>
                ...
                <input type="number" name="txt_telefono" id="txt_telefono" class="form-control" placeholder="Ejemplo: 2222222" required>
                ...
                <input type="number" name="txt_dpi" id="txt_dpi" class="form-control" placeholder="7654321" required>
